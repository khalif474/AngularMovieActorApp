...
mongoose.connect("mongodb://localhost:27017/movesnew", function (err) {
  if (err) {
...
app.get("/actorsget", actors.getActorsInRange);
...
// Added Ones
app.delete("/moviesyear/:year", movies.deleteByYear);
...
app.use("/", express.static(path.join(__dirname, "dist/actorDb")));
